...
def get_optimizer(
    ...
    :param optimizer: one of 'SGD' or 'Adam' or 'AdamW'
    :param learning_rate: the learning rate
    :param momentum: the momentum (if the optimizer uses it)
    :param weight_decay: regularization coefficient
    """
    if optimizer.lower() == "sgd":
        # Create an instance of the SGD optimizer. Use the input parameters learning_rate, momentum
        # and weight_decay
        opt = torch.optim.SGD(
            model.parameters(),
            lr=learning_rate,
        ...
        # Create an instance of the Adam optimizer. Use the input parameters learning_rate, momentum
        # and weight_decay
...
def test_get_optimizer_returns_adamw(fake_model):
    opt = get_optimizer(fake_model, optimizer="adamw", learning_rate=0.001, weight_decay=0.01)
